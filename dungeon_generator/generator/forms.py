...
class DungeonGenerationForm(Form):
    ...
    def clean(self):
        ...
        room_range = (
            data.get("room_min_height"),
            data.get("room_max_height"),
            data.get("room_min_width"),
            data.get("room_max_width"),
        )
        room_factor = (
            data.get("room_min_height_factor"),
            data.get("room_max_height_factor"),
            data.get("room_min_width_factor"),
            data.get("room_max_width_factor"),
        )
